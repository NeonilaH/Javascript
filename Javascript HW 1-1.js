...
// 8. Assign the addition of item_1 and item_2 to item_3
...
// 19. Assign number 15 to the variable item_6
...
// 26. Create a variable "age_1" and assign 10 to it
let age_1 = 10;

// 27. Create variable "age_2" and assign 18 to it
let age_2 = 18;

// 28. Create variable "age_3" and set assign 60 to it
let age_3 = 60;

// 29. Create an if in which you will check the value of the variable age_1
// 30. If age_1 < age_2, print “You don't have access cause your age is ” + age_1 + “ to the console. It's less then"
